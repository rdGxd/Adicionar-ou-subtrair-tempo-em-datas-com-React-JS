  ...
  return (
    <form className="main-form">
      ...
      <label htmlFor="main-date" className="main-date">
        ...
        <span>Data: </span>
        {' '}
        {/* Adiciona um texto "Data:" ao rótulo */}
        <input
          type="date"
          id="main-date"
          value={date}
      ...
      <label htmlFor="more-days">
        ...
        <span>+/- Dias: </span>
        {' '}
        {/* Adiciona um texto "+/- Dias:" ao rótulo */}
        <input
          type="number"
          id="more-days"
          className="number-input"
          value={daysMonthsYears.days}
          onChange={(event) => setDaysMonthsYears(
            { ...daysMonthsYears, days: Number(event.target.value) },
          )}
        />
        {' '}
      ...
      <label htmlFor="more-years">
        ...
        <span>+/- Anos: </span>
        {' '}
        {/* Adiciona um texto "+/- Anos:" ao rótulo */}
        <input
          type="number"
          id="more-years"
          className="number-input"
